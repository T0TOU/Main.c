...
{	
	...
	int count = 0;
		...
		else if (count == 0)
		{
			...
			for (i = 0; i < 3; i++)
			{
				if ((0 < x + 1 < SROW - 1) && (0 < x - 1 < SROW - 1) && (0 < yP1 - i < SCOL - 1))
				{
					if (((board[x + 1][yP1 - i] == '0') && (board[x - 1][yP1 - i] == '0') && (board[x][yP1] == '0') && (board[x][yP1 - 2] == '0')) || ((board2[x + 1][yP1 - i] == '*' || board2[x + 1][yP1 - i] == ' ') && (board2[x - 1][yP1 - i] == '*' || board2[x - 1][yP1 - i] == ' ') && (board2[x][yP1] == '*' || board2[x][yP1] == ' ') && (board2[x][yP1 - 2] == '*' || board[x][yP1 - 2] == ' ')))
					{	
